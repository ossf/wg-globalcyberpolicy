This page contains an index of the Articles detailed within the [CRA](https://eur-lex.europa.eu/eli/reg/2024/2847/oj)
...
|    Article 14         |    Reporting obligations of manufacturers       |        14.1 reporting actively exploited vulns (how to chose the Nations CSIRT) 14.3 notify severe incidents 14.8 inform impacted users, provide mitigation     |
...
|    Article 23         |    Identification of economic operators       |      23 Identification of economic operators 23.1 Provide information to market surveillance authorities: (a) the name and address of any supplier (b) the name and address of any customer (if possible) 23.2. Keep information for 10 years  |
|    Article 24         |    Obligations of open-source software stewards      |   24. Obligations for Stewards: - CVD poliy and practice - shall cooperate with market surveillance at request - provide documentation - see 14 (1,3,8) Reporting   |
|    Article 25         |    Security attestation of free and open-source software       |     25. Attestations Commission empowered to adopt delegated acts in to establishing voluntary security attestation programmes    |
|    Article 26         |    Guidance       |    26.2. Commission to provide guidance, address the following aspects: (a) emote data processing solutions and free and open-source software (b) support periods (c) guidance targeted at manufacturers subject to Union harmonisation legislation  (d) the concept of substantial modification. 26.3 Commission to consult relevant stakeholders.     |
