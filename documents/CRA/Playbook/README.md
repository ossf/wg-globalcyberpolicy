...
Congratulations!  You are one of the parties that controibute to "Products with Digital Elements" (PDE) as detailed in [Article 6](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=OJ:L_202402847#art_6) that will be sold within the European Union.  You are an upstream open source devel;oper, get to be an open source Steward, or perhaps you are a Manufacturuer 
