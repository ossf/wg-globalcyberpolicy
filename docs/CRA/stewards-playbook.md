...
**Important applicability date:** The reporting obligations applicable to open-source software stewards under Article 24(3) **apply from 11 December 2027**. This is distinct from the reporting obligations applicable to manufacturers under Article 14, which apply from 11 September 2026. The European Commission and ENISA have confirmed this interpretation in their respective implementation guidance and FAQs.
...
- Severe incident:
    ...
    - Within 1 month after the submission of the 72-hour Incident notification.
...
This is a living document and we would really appreciate your proposed enhancements - to submit PRs please use this link: https://github.com/ossf/wg-globalcyberpolicy/blob/main/docs/CRA/stewards-playbook.md
